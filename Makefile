# This Makefile is for the POE::SAPI extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/POE/SAPI.pm]
#     AUTHOR => q[Paul G Webster <paul@daemonrage.net>]
#     BUILD_REQUIRES => {  }
#     NAME => q[POE::SAPI]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/POE/SAPI.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/POE/SAPI.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/POE
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/POE
...
TO_INST_PM = lib/POE/SAPI.pm

PM_TO_BLIB = lib/POE/SAPI.pm \
	blib/lib/POE/SAPI.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/POE/SAPI.pm $(INST_MAN3DIR)/POE::SAPI.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               POE-SAPI' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.03' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           The simplified POE API' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The simplified POE API</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/POE/SAPI.pm blib/lib/POE/SAPI.pm 
